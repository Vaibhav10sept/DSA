	...
	while (curr) {
		...
		if (leftNode == NULL) {
			...
			if (rightMostNode->right == NULL) { //create thread.
				...
				ans.push_back(curr->data);
				//thread create krne ke baad left me jao
				curr = curr->left;
			}
...
{
	/*
	PREREQUISITE: morris traversal inorder traversal.
	SPACE: constant.
	...
	VIDEO LINK: https://www.youtube.com/watch?v=8rwHi5CXwqY&list=PL-Jc9J83PIiHgjQ9wfJ8w-rXU368xNX4L&index=2
	*/
