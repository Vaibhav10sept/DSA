...
Node* mergeBinaryTrees(Node* a, Node* b) {
	if (a == NULL and b == NULL) return NULL;
	else if (a != NULL and b == NULL) {
		a->left = mergeBinaryTrees(a->left, b);
		a->right = mergeBinaryTrees(a->right, b);
		return a;
	}
	else if (a == NULL and b != NULL) {
		b->left = mergeBinaryTrees(a, b->left);
		b->right = mergeBinaryTrees(a, b->right);
		return b;
	}
	else if (a != NULL and b != NULL) { // a!= null and b!= null
		Node* newNode = new Node(a->data + b->data);
		cout << "a " << a->data << " b " << b->data << endl;
		newNode->left = mergeBinaryTrees(a->left, b->left);
		newNode->right = mergeBinaryTrees(a->right, b->right);
		return newNode;
	}
}
...
int main()
{
	...
	*/
	...
	Node* root1 = constructorForLeetcode(arr1);
	Node* root2 = constructorForLeetcode(arr2);
	Node* ans = mergeBinaryTrees(root1, root2);
	display(ans);
}