...
void morrisPreorderTraversal(Node* root) {
	//WV recommended
	// NOTE: I wrote this code after modifying "morris inorder traversal" code
	Node* curr = root;
...
int main()
{
	...
	WV recommeneded
	VIDOE: https://www.youtube.com/watch?v=8rwHi5CXwqY&t=969s
	QUESTION: https://takeuforward.org/data-structure/morris-preorder-traversal-of-a-binary-tree/
	*/
