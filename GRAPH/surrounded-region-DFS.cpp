...
void displayMatrix(vector<vector<char>> arr) {
...
int main() {
	/************************************************************
	 * no need to watch video the comments are very good.
	 * VIDEO LINK: https://www.youtube.com/watch?v=BtdgAys4yMk
	NOTE: this code is copied from leetcode solution
	NOTE: mujhe pura smjh aa gya h, pls read the comments
	LEETCODE LINK: https://leetcode.com/problems/surrounded-regions/solutions/691675/c-beginner-friendly-boundary-dfs-inplace/
	//************************************************************/
