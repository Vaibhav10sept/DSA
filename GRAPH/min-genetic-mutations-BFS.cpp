...
int main() {
	//************************************************************
	//VIDEO LINK: no video this code is copied from leetcode, and I can understand
	//LEETCODE LINK: https://leetcode.com/problems/minimum-genetic-mutation/description/
	//NOTE: please read the comments for better understanding.
