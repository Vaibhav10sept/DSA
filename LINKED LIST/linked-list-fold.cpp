...
int main()
{
	// Note: we can also do this recursively, the code is not here
	// but you can watch the video(pepcoding youtube). This one is
	// my own iterative code.
	LinkedList ll;
	ll.addFirst(6);
	ll.addFirst(5);
	ll.addFirst(4);
