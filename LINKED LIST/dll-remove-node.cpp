	...
	void removeNode(Node* node) {
		...
		while (temp) {
			...
			if (temp == node) { //node found
				if (temp->prev == NULL and temp->next == NULL) { //one size list
					//make list empty
					head = tail = NULL;
					size--;
					return;
				...
				else { //every other case, temp ko remove krna hai
...
{
	/*
	VIDEO LINK: 	VIDEO LINK: https://www.youtube.com/watch?v=Jiqb2skiNbM&list=PL-Jc9J83PIiGRqcfZxxgOKovgLVd3znnq&index=44
